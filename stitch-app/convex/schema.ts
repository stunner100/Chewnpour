...
export default defineSchema({
    ...
    topics: defineTable({
        ...
        contentGraph: v.optional(v.any()),
        structuredDefinitions: v.optional(v.array(v.any())),
        structuredExamples: v.optional(v.array(v.any())),
        structuredFormulas: v.optional(v.array(v.any())),
        structuredLearningObjectives: v.optional(v.array(v.any())),
        structuredLikelyConfusions: v.optional(v.array(v.any())),
        structuredSourceBlockIds: v.optional(v.array(v.string())),
        structuredSourcePages: v.optional(v.array(v.number())),
        structuredSubtopics: v.optional(v.array(v.any())),
        ...
        difficultyDistribution: v.optional(v.any()),
    ...
    questions: defineTable({
        ...
        sourcePassageIds: v.optional(v.array(v.string())),
        sourceClaimIds: v.optional(v.array(v.string())),
        ...
        subClaimId: v.optional(v.string()),
