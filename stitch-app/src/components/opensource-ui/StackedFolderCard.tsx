...
const TRANSITION =
  "transition-[top,left,width,height,transform,box-shadow] duration-[400ms] ease-[cubic-bezier(0.22,1,0.36,1)]";
  ...
  function StackedFolderCard(
    {
      ...
      backImageSrc,
      middleImageSrc,
      backClassName = "bg-error-soft",
      middleClassName = "bg-surface-muted",
      frontClassName = "bg-primary-subtle",
      ...props
    },
    ref,
  ) {
    ...
    const layers: LayerConfig[] = [
      ...
      },
      {
        ...
        src: imageSrc,
        alt: imageAlt,
        surfaceClassName: frontClassName,
      },
    ];
