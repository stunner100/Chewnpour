        ...
        <div className="student-dashboard flex-1 pt-space-6 px-space-6 md:px-space-8 pb-space-16 max-w-container-max mx-auto w-full min-w-0">
            ...
            <nav aria-label="Study shortcuts" className="grid grid-cols-2 lg:grid-cols-4 gap-space-3 mb-space-8 min-w-0">
                {quickActions.map((action) => (
                    <Link
                        key={action.href}
                        to={action.href}
                        className={`group min-w-0 rounded-xl border border-border-subtle bg-surface-soft/60 dark:!bg-[#161719] px-space-4 py-space-4 hover:bg-surface dark:hover:!bg-[#212226] hover:border-border-default transition-[background-color,border-color] ${FOCUS_RING}`}
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] gap-space-6 min-w-0">
                <section className="min-w-0">
                    ...
                    <section className="mt-space-6 rounded-xl bg-ai-subtle dark:!bg-[#161719] border border-border-subtle p-space-5 md:p-space-6 min-w-0">
