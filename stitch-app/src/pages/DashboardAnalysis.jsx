...
const DashboardAnalysis = () => {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark font-body antialiased min-h-screen flex flex-col transition-colors duration-300">
            <header className="sticky top-0 z-50 w-full glass border-b border-slate-200/50 dark:border-slate-800/50">
                <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center justify-between gap-8">
                    <div className="flex items-center gap-3 shrink-0">
                        ...
                        <span className="text-xl font-display font-bold tracking-tight text-slate-900 dark:text-white hidden sm:block">Study Group</span>
                    </div>
            ...
            <main className="flex-1 w-full max-w-[1600px] mx-auto px-4 py-8 md:px-6 md:py-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    <div className="lg:col-span-8 flex flex-col animate-slide-up">
                        <div className="relative w-full h-full overflow-hidden rounded-[2rem] bg-surface-light dark:bg-surface-dark p-8 md:p-12 shadow-soft border border-slate-200/60 dark:border-slate-800 group isolate">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between h-full gap-8">
                                <div className="flex-1 space-y-6">
                                    ...
                                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-extrabold text-slate-900 dark:text-white leading-[1.1] tracking-tight">
                                    ...
                                    <div className="pt-2">
                                        ...
                                        <button
                                            ...
                                            disabled={uploading}
                                            className="flex items-center gap-3 bg-primary hover:bg-primary-hover active:bg-primary-dark transition-all hover:-translate-y-0.5 text-white px-8 h-14 rounded-2xl text-lg font-bold shadow-lg shadow-primary/25 hover:shadow-primary/40 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none w-fit"
                                        >
                    ...
                    <div className="lg:col-span-4 flex flex-col h-full animate-slide-up animate-delay-100">
                        <Link to="/dashboard/exam" className="relative h-full flex flex-col justify-between overflow-hidden rounded-[2rem] bg-surface-light dark:bg-surface-dark border-2 border-transparent hover:border-primary/20 p-8 shadow-soft transition-all duration-300 cursor-pointer group hover:shadow-xl hover:-translate-y-1">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-500 dark:text-slate-400 font-medium leading-relaxed mb-6">
                                    Master your upcoming finals with our database of past papers.
                                </p>
                            </div>
