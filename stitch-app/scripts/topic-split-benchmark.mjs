...
const run = async () => {
    ...
    const pdfCandidates = [
        ...
        path.resolve("./docling-service/notebooks/sample_data/wipo_financial_report_min.pdf"),
        path.resolve("./docling-service/notebooks/sample_data/wipo_financial_report.pdf"),
        path.resolve("./docling-service/notebooks/sample_data/wipo_doc_to_restore.pdf"),
    ];
