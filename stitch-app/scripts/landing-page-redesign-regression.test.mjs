...
assert(landingPage.includes('LandingDashboardPreview'), 'Hero uses the live dashboard preview');
assert(landingPage.includes('LandingLessonPreview'), 'AI section uses the live lesson preview');
assert(!landingPage.includes('/redesign/product-mockup'), 'Landing no longer uses the Apple Notes mockup asset');
