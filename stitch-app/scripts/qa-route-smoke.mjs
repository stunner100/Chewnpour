...
const ROUTES = [
    ...
    { path: '/dashboard/search', label: 'Library redirect', visibility: 'protected' },
    ...
    { path: '/dashboard/exam', label: 'Quiz redirect', visibility: 'protected' },
    ...
    { path: '/dashboard/analysis', label: 'Progress redirect', visibility: 'protected' },
    ...
    { path: '/subscription', label: 'Settings subscription redirect', visibility: 'protected' },
    { path: '/subscription/callback', label: 'Subscription Callback', visibility: 'protected' },
    { path: '/profile', label: 'Settings profile redirect', visibility: 'protected' },
    { path: '/profile/edit', label: 'Settings profile edit redirect', visibility: 'protected' },
